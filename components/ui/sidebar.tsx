  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-(--sidebar-width) flex-col bg-sidebar text-sidebar-foreground dark:bg-zinc-950 ",
            className,
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground dark:bg-zinc-950 [&>button]:hidden "
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden text-sidebar-foreground md:block dark:bg-zinc-950 "
        data-state={state}
